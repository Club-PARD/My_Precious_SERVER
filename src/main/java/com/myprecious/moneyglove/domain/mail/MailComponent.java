...
//                "<html><body>" +
//                        "<p>안녕하세요. 머니글러브입니다.</p>" +
//                        "<p>만약 현재 조금이라도 여유돈이 생겼다면 돈을 빌려준 친구들 한명한명씩 갚아보세요!</p>" +
//                        "<p>나중에 한번에 갚으려면 힘들 수도 있어요.</p>" +
...
//                "<html><body>" +
//                        "<p>안녕하세요. 머니글러브입니다.</p>" +
//                        "<p>오늘은 돈을 갚기로 약속한 날짜입니다!</p>" +
//                        "<p>머글님을 도와준 친구들은 머글님께서 힘들 때 머글님을 생각해준 소중한 친구입니다.</p>" +
//                        "<p>이런 소중한 친구들과의 관계를 지키기 위해서는 약속을 지키는 것은 필수겠죠?</p>"+
//                        "<p><a href=\"https://precious-relationship.web.app\">Money Glove</a></p>" +
//                        "</body></html>");
//
...
//                "<html><body>" +
//                        "<p>안녕하세요. 머니글러브입니다.</p>" +
//                        "<p>돈을 갚기로 한 날짜가 지났어요!</p>" +
//                        "<p>머글님을 도와준 친구들은 머글님께서 힘들 때 머글님을 생각해준 소중한 친구입니다.</p>" +
//                        "<p>이런 소중한 친구들과의 관계를 지키기 위해서 지금이라도 사과하고 돈을 갚아주세요.</p>" +
//                        "<p>[주의: 채무불이행은 엄연한 불법입니다. 친구들의 신뢰가 많이 깎이면 법적 문제로 불거질 수 있습니다. " +
//                        "머글님이 쓰신 게시물은 삭제 및 수정이 불가능하며 법정에서 불리한 자료로 사용될 수 있습니다. " +
//                        "형법 제347조 (사기) 사람을 기망하여 재물의 교부를 받거나 재산상의 이익을 취득한 자는 10년 이하의 징역 또는 2천만원 이하의 벌금에 처한다. " +
//                        "민법 제390조 (채무불이행과 손해배상) 채무자가 채무의 내용에 좇은 이행을 하지 아니한 때에는채권자는 손해배상을 청구할 수 있다.]</p>" +
//                        "<p><a href=\"https://precious-relationship.web.app\">Money Glove</a></p>" +
//                        "</body></html>");
//    }
//
