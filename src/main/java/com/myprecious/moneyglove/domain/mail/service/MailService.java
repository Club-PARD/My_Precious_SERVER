    ...
    public ResponseDto<UserSendMailResponseDTO> lentMoney(String userAddress){
        try {
            ...
            String htmlContent = "<html><body>" +
                    "<p>안녕하세요. 머니글러브입니다." +
                    "<p>친구가 돈을 빌려줬어요!" +
                    "<p>지금 게시물 관리 페이지로 이동하여 확인하고 감사 편지를 보내보세요." +
                    "<p> 감사 편지 한 장이 머글님의 친구들에게 큰 기쁨이 될 거예요." +
                    "<p>[만약 빌려준 돈과 실제로 계좌에 들어온 금액이 다르다면 moneyglove2024@gmail.com로 문의주세요.]>" +
                    "<p><a href=\"https://precious-relationship.web.app\">Money Glove</a></p>" +
                    "</body></html>";
    ...
    public ResponseDto<UserSendMailResponseDTO> paidAll(String userAddress){
        try {
            ...
            String htmlContent = "<html><body>" +
                    "<p>안녕하세요. 머니글러브입니다." +
                    "<p>빌린 모든 금액을 갚으셨습니다." +
                    "<p>머글님의 친구 관계를 지키기 위한 책임감 있는 모습에 박수를 보내드립니다!!!" +
                    "<p>한때 힘들었던 시간 함께 도와줬던 친구들에게 감사하다고 한 번 더 말해보는 것은 어떨까요?" +
                    "<p>지금까지 “돈도 지키고 우정도 지키자!” MoneyGlove를 이용해 주셔서 감사합니다." +
                    "<p><a href=\"https://precious-relationship.web.app\">Money Glove</a></p>" +
                    "</body></html>";
    ...
    public ResponseDto<UserSendMailResponseDTO> paidOne(String userAddress){
        try {
            ...
            String htmlContent = "<html><body>" +
                    ...
                    "<p>MoneyGlove를 통해 친구와 꾸준히 소통해 주세요!</p>" +
                    "<p><a href=\"https://precious-relationship.web.app\">Money Glove</a></p>" +
                    "</body></html>";
